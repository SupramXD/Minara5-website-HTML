...
- **Canonical return terms (all pages must match):** 7-day window; exchange = two-way courier fee R85 x 2 = R170; refund = R85 return fee deducted, plus a possible 15% administrative fee; damaged/leaking bottle reported within 7 days with photos. The old R120/R240 variant was removed.
- Policy page size is deliberate: `about.html` 5 blocks, `terms.html` 8 clauses, `privacy.html` 8 clauses. Keep them short and consistent with the returns page.
