  ...
  window.loadCustomTextSettings = async function() {
    ...
    const populateFields = (data) => {
      ...
      const defaultAdminPolicy = {
        ...
        disclaimerText: "STUDIO EXTRAIT is an independent fragrance label. We are not affiliated with, endorsed by, sponsored by or connected to any other fragrance house, designer or brand owner, and none of our products are made or supplied by them.\n\nAll fragrance names, bottle designs, photography and website text shown here belong to STUDIO EXTRAIT. Third-party trademarks remain the property of their respective owners.",
