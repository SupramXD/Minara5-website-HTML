...
(function () {
  const defaultPolicy = {
    ...
    disclaimerText: "<p>STUDIO EXTRAIT offers original Extraits de Parfum formulated independently in South Africa and sold under its own brand label. Every fragrance is named after its own scent profile and is created from our own accord, not from any third-party formula.</p>\n<p>Our products are not associated with, endorsed by, sponsored by, or manufactured by any third-party brand owner. Any reference to a scent family, note or olfactory style is descriptive only. All trademark rights remain the property of their respective owners.</p>\n<p>Our packaging and bottle designs are unique to STUDIO EXTRAIT and do not imitate or copy any third-party logo or trade dress.</p>",
